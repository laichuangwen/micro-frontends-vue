...
import stripeUse from './stripe.md'
import borderUse from './border.md'
import heightUse from './height.md'
import headerUse from './header.md'
import singleUse from './single.md'
import multipleUse from './multiple.md'
import sortUse from './sort.md'
import filtersUse from './filters.md'
...
<base-use></base-use>
<stripe-use></stripe-use>
<border-use></border-use>
<height-use></height-use>
<header-use></header-use>
<single-use></single-use>
<multiple-use></multiple-use>
<sort-use></sort-use>
<filters-use></filters-use>
...
| `-分割线-` | `---` | `---` | `---` | `---`
| column  | 列表配置 | array | [column](/ui/table-plus#tableplus-column) | [] |
