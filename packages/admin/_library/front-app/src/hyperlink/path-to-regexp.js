 ...
 * @return {!Array}
 */
export const parse = function(str, options) {
    const tokens = []
    let key = 0
    let index = 0
    let path = ''
 ...
 */
export const compile = function(str, options) {
 ...
 */
export const tokensToFunction = function(tokens) {
 ...
 * @return {!RegExp}
 */
export const regexpToRegexp = function(path, keys) {
    if (!keys) return path
 ...
 * @return {!RegExp}
 */
export const tokensToRegExp = function(tokens, keys, options) {
    options = options || {}
